	...
	<div id="background">
	          <form action="RegisterServlet" method="post">  
	            ...
	            <div id="d2">
	                ...
	                <input type="PASSWORD" placeholder="비밀번호를 확인하세요." id="PWCHECK" name="PWCHECK" required><input type="button" value="비밀번호 확인" onclick="checkPW(),submitPassword()" id="checkPwButton"><br>
	            </div>
